...
public class FormularioPersona extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1082, 800));

        jPanel1.setBackground(new java.awt.Color(204, 204, 255));
        jPanel1.setPreferredSize(new java.awt.Dimension(1200, 800));

        jLabel1.setFont(new java.awt.Font("Source Serif Pro", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(51, 51, 255));
        jLabel1.setText("LISTADO DE USUARIOS EN SISTEMA:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID:", "Nombre", "Apellido 1", "Apellido 2", "Año de nacimiento", "Correo electrónico"
            }
        ) {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagen/usuario1.png"))); // NOI18N
        jLabel8.setBorder(javax.swing.BorderFactory.createEtchedBorder());

        jLabel9.setFont(new java.awt.Font("Source Serif Pro", 1, 24)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 255));
        jLabel9.setText("INTRODUZCA LOS DATOS DEL USUARIO:");

        jButton1.setBackground(new java.awt.Color(0, 204, 204));
        jButton1.setFont(new java.awt.Font("Source Sans Pro", 1, 14)); // NOI18N
        ...
        jButton3.setFont(new java.awt.Font("Source Sans Pro", 1, 14)); // NOI18N
